...
namespace PharmacyManagementVideo.AdministratorUC
{
    public partial class UC_AddUser : UserControl
    {
        ...
        private void txtUsername_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                pictureBox1.ImageLocation = @"E:\Pharmacy Project\C# Pharmacy Management System\Pharmacy Management System in C#\yes.png";
            }
            else
            {
                pictureBox1.ImageLocation = @"E:\Pharmacy Project\C# Pharmacy Management System\Pharmacy Management System in C#\no.png";
            }
